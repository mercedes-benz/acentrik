...
7. To confidently validate above prerequisite, a **Hello world API** could deployed on your infrastucture setup and cover at least point 3, 6. Then the kubernetes object can be replace with Edge Node component.
